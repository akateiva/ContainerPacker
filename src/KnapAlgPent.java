...
public class KnapAlgPent {
	...
	private static APentomino option;
	...
	public static void main(String[] args) {
		...
		while(populationSize>0) {
			...
			boxes = 264;
			optionsUsed = new APentomino[boxes];
			
			while(boxes>0) {
				place = true;
				type = rand.nextInt(8);
				rotation = rand.nextInt(4);
				option = new APentomino(type);
	...
	public static TruckSpace crossover(TruckSpace t_1, TruckSpace t_2) {
		APentomino[] result = new APentomino[t_1.getPentOptionsArray().length];
